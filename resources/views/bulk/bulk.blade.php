    ...
    <x-app-layout>
        <div class="mx-auto my-auto overflow-hidden relative flex flex-col items-center bg-[#FF6400]">
            ...
            <form id="popup-main"
                ...
                <div id="popup-tnc"
                    class="hidden fixed w-full h-screen z-30 px-10 pt-10 pb-8 items-center justify-center bg-[#00000080]">

                    <div
                        class="relative border-4 rounded-3xl w-full md:w-[30%] h-96 p-7 overflow-scroll bg-orange-700 border-orange-900 flex flex-col items-center justify-between overflow-x-hidden">
                        <button onclick="closeTnc()"
                        ...
                        <p class="text-orange-300 font-averialibre text-lg md:text-xl text-justify md:mb-0 mb-3">Perlu
                            diingat bahwa pemesanan membutuhkan persetujuan dari pihak kami, Persetujuan akan kami kirim
                            via email dan anda akan dikontak oleh admin.</p>
                        <button type="submit" onclick="tncComplete()"
            ...
            <div id="popup-done"
                ...
                <div
                    ...
                    <p class="text-orange-300 font-averialibre text-2xl md:text-3xl text-justify">Permohonan terkirim!
                    </p>
                    <p class="text-orange-300 font-averialibre text-xl text-center">Cek email atau page my order untuk
                        pemberitahuan berikutnya.</p>
                    <button onclick="doneComplete()"
                        class="mx-1 border-2 rounded-xl hover:bg-orange-400 hover:border-orange-800 border-orange-900 bg-orange-800 font-averialibre text-2xl px-2  w-full py-1 h-16 text-center hover:text-orange-700 text-orange-300">
                ...
                <div class="flex flex-col items-center relative md:justify-normal justify-center h-full ">
                    ...
                    <div class="flex flex-col md:flex-row w-[90%] mt-2 justify-center md:items-center md:h-[80%]">
                        ...
                        <div class="w-full md:w-[50%] flex flex-col justify-center md:pr-7 z-10">
                            <!-- SERIES #1 -->
                            <p class="text-orange-800 font-averialibrebold text-5xl mx-auto mb-6"
                                style="text-shadow: 4px 4px 4px #FFFFFF, -4px -4px 4px #FFFFFF, 4px -4px 4px #FFFFFF, -4px 4px 4px #FFFFFF;">
                                BULK ORDER</p>
            ...
            <div id="menu-bulk" class="pt-24 md:pt-12 w-full flex flex-col items-center z-10 py-12 bg-orange-500">
                <p class="text-orange-800 font-averialibre text-2xl md:text-5xl mx-auto -mt-5 mb-5"
                    style="text-shadow: 4px 4px 4px #FFFFFF, -4px -4px 4px #FFFFFF, 4px -4px 4px #FFFFFF, -4px 4px 4px #FFFFFF;">
