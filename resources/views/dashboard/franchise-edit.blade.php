                ...
                <form action="/admin/package/{{$package->id}}/update"
                    ...
                    <div class="mt-6 flex flex-col md:flex-row justify-between">
                        ...
                        <input type="text" id="title" name="title"
                            class="@error('title') border-red-500 @enderror md:w-3/4 mt-1 p-2 bg-[#FDED87] rounded-2xl border-solid border-2 border-[#945E3D]" value="{{ old('title',  $package->title)}}">
                    </div>
                    @error('title')
                        <div class="text-sm text-red-600">{{ $message }}</div>
                    @enderror
                    ...
                    <div class="mt-6 flex flex-col md:flex-row justify-between">
                        ...
                        <input type="number" id="price" name="price"
                            class="@error('price') border-red-500 @enderror md:w-3/4 mt-1 p-2 bg-[#FDED87] rounded-2xl border-solid border-2 border-[#945E3D]" value="{{old('price',  $package->price)}}">
                    </div>
                    @error('price')
                        <div class="text-sm text-red-600">{{ $message }}</div>
                    @enderror
