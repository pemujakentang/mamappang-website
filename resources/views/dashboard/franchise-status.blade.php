        ...
        <div class="flex-auto min-h-screen bg-[#FFDBA3] pt-20 md:pt-0">
            ...
            <div class="md:ml-64 p-8 ">
                <div class="flex md:flex-row flex-col items-center w-full md:justify-between">
                    <div class="col-span-2 lg:col-span-1 text-3xl lg:text-5xl tracking-wide truncate font-averialibre text-orange-800">Franchise Status</div>
                </div>
                <div class="p-4 lg:p-8 grid grid-cols-1 lg:grid-cols-2 gap-4 border border-solid border-[#F1A03C] rounded-2xl bg-[#b9480f] overflow-y-auto">
                    ...
                    <div class="bg-[#f1a03c] border-solid border-4 border-[#F1A03C] p-4 lg:p-6 rounded-2xl mb-4">
                        ...
                        <span class="ml-2 font-averialibre text-orange-800 text-4xl lg:text-5xl uppercase" style="-webkit-text-stroke: 1px rgba(255,255,255,0.8);">FRC 1</span>
                            </div>
                    ...
                    </div>                    <div class="bg-[#f1a03c] border-solid border-4 border-[#F1A03C] p-4 lg:p-6 rounded-2xl mb-4">
                        <!-- Item 1 -->
                        <div class="flex justify-between items-center mb-8 lg:mb-16">
                            <div class="flex items-center">
                        <span class="ml-2 font-averialibre text-orange-800 text-4xl lg:text-5xl uppercase" style="-webkit-text-stroke: 1px rgba(255,255,255,0.8);">FRC 1</span>
...
<div id="modal" class="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 hidden overflow-y-auto">
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#b9480f] text-orange-800 p-4 rounded-2xl border border-solid border-[#F1A03C] max-w-[90%] lg:max-w-[500px]">
         <div class="flex justify-between items-center mb-4">
            ...
            <span id="state" class="mr-2 font-averialibre text-[#FAC774] text-4xl self-end">Pending</span>
        </div>
        <div class="flex justify-center items-center rounded-2xl ">
            <div class="flex flex-col w-[400px]">
                ...
                <div class="font-averialibre w-full h-auto bg-[#945e3d] flex justify-start items-start">
...
function replaceContent(action) {
    ...
    document.querySelector('.self-end').innerText = 'Approved';
    ...
    if (action === 'terima') {
        ...
        replacementContent.innerHTML = `
            ...
            <div id="greenSectionContent" class="flex-1 flex items-center justify-between">
                <span class="text-orange-800">Follow Up Via WhatsApp</span>
                <button onclick="toggleModal()" class="font-averialibre text-orange-800 text-2xl flex items-center justify-center bg-[#fded87] text-[#b9480f] rounded-full h-[35px] w-[150px] border border-[#b9480f]">
                    <!-- Chat bubble icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3c4.97 0 9 4.03 9 9s-4.03 9-9 9-9-4.03-9-9 4.03-9 9-9zm-1.5 4a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm3 3a1.5 1.5 0 110-3 1.5 1.5 0 010 3zm-3 3a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm3 3a1.5 1.5 0 110-3 1.5 1.5 0 010 3z"/>
                    </svg>
                </button>
            </div>
        `;
