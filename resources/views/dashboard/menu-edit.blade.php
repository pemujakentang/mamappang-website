            ...
            <div class="flex-auto min-h-screen bg-[#FFDBA3]">
                ...
                <div class="ml-0 md:ml-64 md:p-8 p-2 md:pt-4 pt-16">
                    <div class="flex-col flex">
                        <p
                            class="col-span-1 text-5xl tracking-wide truncate font-averialibre text-orange-800 flex mx-auto md:mx-0">
                            Edit
                        </p>
                        <div
                            ...
                            <div class="w-full md:w-auto">
                                <button
                                    ...
                                    <a href="/admin/dashboard/add-series"
                                        class="ml-4 mr-4 font-averialibre text-orange-800 text-xl md:text-2xl">Tambah
                                        Series</a>
                                </button>
                            </div>
                            <div class="w-full md:w-auto">
                            ...
                            <div class="w-full md:w-auto">
                                <button
                                    ...
                                    <a href="{{ route('franchise-create') }}"
                                        class="mx-3 font-averialibre text-orange-800 text-xl md:text-2xl text-center">Tambah
                                        Franchise</a>
                                </button>
                            </div>
                        </div>
                                        ...
                                        <li
                                            ...
                                            <div class="flex space-x-2">
                                                <a class="text-blue-500" href="/admin/menu/{{ $menu->id }}/edit">
                                                    <p class="ml-4 mr-4 font-averialibre text-orange-800 text-2xl">Edit
                                                    </p>
                                                </a>
                                                <form action="/admin/menu/{{ $menu->id }}/delete" method="POST"
                                                    ...
                                                    @method('delete')
                                                    <button type="submit" class="text-red-500">
                                                        <p class="ml-4 mr-4 font-averialibre text-redx text-2xl">Delete
                                                        </p>
                                                    </button>
                                                </form>
                                            </div>
