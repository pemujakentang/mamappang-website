            ...
            <div class="flex-auto min-h-screen bg-[#FFDBA3]">
                ...
                <div class="ml-0 md:ml-64 md:p-8 p-2 md:pt-0 pt-20">
                    <div class="flex-col flex">
                        <div class="col-span-1 text-5xl tracking-wide truncate font-averialibre text-orange-800">Menus
                        </div>
                        <div class="mt-2 flex flex-col md:flex-row gap-3 md:justify-normal justify-center items-center">
                            <div class="w-full md:w-auto">
                                <button
                                    class="bg-[#FDED87] rounded-2xl border-solid border-4 border-[#F1A03C] w-full md:w-35 py-2">
                                    <a href=""
                                        class="ml-4 mr-4 font-averialibre text-orange-800 text-2xl text-center">Edit
                                        Harga Bulk</a>
                                </button>
                            </div>
                            <div class="w-full md:w-auto">
                                <button
                                    ...
                                    <a href="/admin/dashboard/add-series"
                                        class="ml-4 mr-4 font-averialibre text-orange-800 text-2xl">Tambah Series</a>
                                </button>
                            </div>
                            <div class="w-full md:w-auto">
                                <button
                                    ...
                                    <a href="/admin/dashboard/add-menu"
                                        class="ml-4 mr-4 font-averialibre text-orange-800 text-2xl">Tambah Rasa</a>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="rounded-2xl border-solid border-4 border-[#F1A03C] mt-6 mb-6 bg-[#FAC774] mr-2 simplebar">
                            ...
                            @foreach ($categories as $category)
                                <li
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <form action="/admin/series/{{ $category->id }}/delete" method="POST"
                                ...
                                @foreach ($category->menus as $menu)
                                    <li
                                        class="flex justify-between items-center bg-[#FAC774] border-solid border-4 border-[#F1A03C] p-2 rounded-2xl md:ml-12 mx-4 flex-col md:flex-row">
                                        <div class="flex items-center">
                                            <img class="object-cover h-14 transform scale-x-[-1] -translate-y-2 mt-2"
                                                src="/images/ikan.webp" alt="Logo">
                                            <span
