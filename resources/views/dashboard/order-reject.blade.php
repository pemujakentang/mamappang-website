            ...
            <div
                ...
                <div class="ml-0 md:ml-64 p-3 md:p-8 ">
                    ...
                    <div class="rounded-2xl border-solid border-4 border-[#F1A03C] my-6 bg-[#FAC774] overflow-y-auto">
                        ...
                        <form action="/preorder/{{ $preorder->id }}/reject" class="w-full flex justify-center flex-col"
                                ...
                                <div class="mt-1 flex items-center w-1/2">
                                    ...
                                    <div class="flex pt-4 w-full">
                                        <textarea name="message"
                                            class="p-2 w-[90%] bg-[#FDED87] rounded-2xl border-solid border-2 border-[#945E3D] md:ml-10 font-averialibre placeholder-orange-700"></textarea>
                                    </div>
                                </div>
                            </div>
