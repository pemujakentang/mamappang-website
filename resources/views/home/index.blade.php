...
<body>
<div class="overflow-scroll flex flex-col items-center bg-[#FF6400] overflow-x-hidden relative">
    <div class="h-screen">
        <!-- navbar -->
        <div id="navbar" class="flex justify-between w-screen h-16 pt-3 pr-5 items-center z-10">
            <div class="w-[10%]flex items-center justify-center">
                <img class="object-cover h-16" src="/images/logo.webp" alt="Logo">
            </div>
            <div class="w-[75%] flex h-full px-10 rounded-full border-2 border-yellow-800 bg-orange-300 items-center justify-between">
            ...
            <button href="" class="w-[12%] flex h-full ml-3 rounded-full border-2 border-yellow-800 bg-orange-300 items-center justify-center">
    ...
    <div class="w-full flex flex-col items-center z-10" style="background-image: url('/images/background-menu.webp');">
        <p class="text-orange-800 font-averialibre text-5xl mx-auto my-10" style="text-shadow: 4px 4px 4px #FFFFFF, -4px -4px 4px #FFFFFF, 4px -4px 4px #FFFFFF, -4px 4px 4px #FFFFFF;">Our Menu</p>
        <div class="flex flex-row w-[90%] mt-10">
            <div class="w-[50%]">
                <div class="w-[80%] flex items-center justify-center mx-auto mb-16">
            ...
            <div class="w-[50%] flex flex-col">
                <!-- SERIES #1 -->
                <p class="text-orange-800 font-averialibre text-5xl mx-auto" style="text-shadow: 4px 4px 4px #FFFFFF, -4px -4px 4px #FFFFFF, 4px -4px 4px #FFFFFF, -4px 4px 4px #FFFFFF;">COKLAT SERIES</p>
                <div class="grid grid-cols-2 w-[95%] mx-auto mt-2 mb-4">
                    <!-- RASA -->
                    <div class="flex mt-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Coklat</p>
                    </div>
                    ...
                    <div class="flex mt-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Coklat keju</p>
                    </div>
                    ...
                    <div class="flex mt-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Coklat vanilla</p>
                    </div>
                    ...
                    <div class="flex mt-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Coklat Oreo</p>
                    </div>
                    ...
                    <div class="flex mt-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Coklat caramel</p>
                    </div>
                    
                </div>

                <!-- SERIES #2 -->
                <p class="text-orange-800 font-averialibre text-5xl mx-auto" style="text-shadow: 4px 4px 4px #FFFFFF, -4px -4px 4px #FFFFFF, 4px -4px 4px #FFFFFF, -4px 4px 4px #FFFFFF;">VANILLA SERIES</p>
                <div class="grid grid-cols-2 w-[95%] mx-auto mt-2 mb-4">
                    <!-- RASA -->
                    <div class="flex mt-2">
                        <div class="w-8 flex items-center justify-center mr-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Vanilla</p>
                    </div>
                    ...
                    <div class="flex mt-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Vanilla Keju</p>
                    </div>
                    ...
                    <div class="flex mt-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Vanilla Oreo</p>
                    </div>
                    ...
                    <div class="flex mt-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Vanilla Caramel</p>
                    </div>      
                </div>

                <!-- SERIES #3 -->
                <p class="text-orange-800 font-averialibre text-5xl mx-auto" style="text-shadow: 4px 4px 4px #FFFFFF, -4px -4px 4px #FFFFFF, 4px -4px 4px #FFFFFF, -4px 4px 4px #FFFFFF;">OTHER SERIES</p>
                <div class="grid grid-cols-2 w-[95%] mx-auto mt-2 mb-4">
                    <!-- RASA -->
                    <div class="flex mt-2">
                        <div class="w-8 flex items-center justify-center mr-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Strawberry</p>
                    </div>
                    ...
                    <div class="flex mt-2">
                        ...
                        <p class="text-orange-800 font-averialibre text-4xl">Blueberry</p>
                    </div>

                </div>
            </div>
        </div>
        <button href="" class="flex h-28 w-[50%] rounded-full border-2 border-yellow-800 bg-[#FF6400] items-center justify-center mx-4 my-16">
    ...
    <div class="w-full flex flex-col relative items-center bg-[#F1A03C]">
        ...
        <img class="absolute h-96 z-0 -left-64 mt-5" src="/images/awan.webp" alt="Logo">
        <img class="absolute h-96 z-0 -right-64 bottom-0 mt-5" src="/images/awan.webp" alt="Logo">
