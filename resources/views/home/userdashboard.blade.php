...
<body>
    <div class="mx-auto my-auto overflow-y-hidden relative overflow-x-hidden flex flex-col items-center bg-[#FF6400]">
        ...
        <!-- popup / pending -->
        <div id="popup-sstatus"
            class="hidden fixed w-full h-screen z-30 px-2 md:px-10 md:pt-10 pt-20 pb-2 md:pb-8 items-center justify-center bg-[#00000080]">
            <div
                class="border-4 rounded-3xl w-full md:w-[50%] h-full px-5 md:px-7 pt-16 pb-5 overflow-scroll bg-orange-800 border-orange-500 flex flex-col relative overflow-x-hidden justify-center">
                ...
                <div
                    class="flex flex-row gap-x-2 my-4 px-4 py-2 font-averialibre text-xl bg-orange-900 w-full rounded-xl text-orange-300">
                ...
                <div class="flex flex-col rounded-xl bg-orange-200 p-1 gap-y-1">
                    ...
                    <div class="px-4 py-2 flex-col flex bg-orange-700 rounded-xl">
                        ...
                        <div class="flex flex-row">
                            ...
                            <div class="w-auto">
                                <p class="font-averialibre text-lg md:text-2xl text-orange-400">Jl scientia boulevard
                                    blok b25 no 4 tangerang selatan</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <button onclick="openForm()"
                            class="border-2 rounded-xl hover:bg-orange-600 hover:border-orange-800 border-orange-900 bg-orange-300 font-averialibre text-2xl px-2 w-full py-2 h-16 text-center hover:text-orange-300 text-orange-700">
        ...
        <div id="popup-warning"
            class="hidden fixed w-full h-screen z-40 px-10 pt-10 pb-8 items-center justify-center bg-[#00000080]">
            <div
                class="border-4 rounded-3xl w-full md:w-[30%] h-96 p-7 overflow-scroll bg-orange-700 border-orange-900 flex flex-col items-center justify-between overflow-x-hidden">
                <p class="text-orange-300 font-averialibre text-5xl">ⓘ</p>
                <p class="text-orange-300 font-averialibre text-2xl md:text-3xl text-justify mb-3">Apakah anda yakin
                    ingin menghapus pesanan?</p>
                ...
                <button onclick="hapus()"
                    class="mx-1 border-2 rounded-xl hover:bg-orange-400 hover:border-orange-800 border-orange-900 bg-orange-800 font-averialibre text-2xl px-2  w-full py-1 h-16 text-center hover:text-orange-700 text-orange-300">
        ...
        <!-- franchise / pending -->
        <div id="popup-franchise"
            class="hidden fixed w-full h-screen z-30 px-2 md:px-10 md:pt-10 pt-20 pb-2 md:pb-8 items-center justify-center bg-[#00000080]">
            <div
                class="border-4 rounded-3xl w-full md:w-[50%] h-full px-5 md:px-7 pt-16 pb-5 overflow-scroll bg-orange-800 border-orange-500 flex flex-col relative overflow-x-hidden justify-center">

                <button onclick="closeFrc()"
                    class="flex absolute cursor-pointer rotate-45 right-5 top-2 font-averialibrebold text-5xl scale-[1.3] text-orange-300 hover:text-orange-950">+</button>
                ...
                <div class="flex flex-col rounded-xl bg-orange-200 p-1 gap-y-1">
                    ...
                    <div class="px-4 py-2 flex-col flex bg-orange-700 rounded-xl">
                        ...
                        <div class="flex flex-row py-2">
                            ...
                            <div class="w-auto">
                                <p class="font-averialibre text-lg md:text-2xl text-orange-400">Jl scientia boulevard
                                    blok b25 no 4 tangerang selatan masa sih yaoi ya lesyfhi djndj</p>
                            </div>
                        </div>
                        <div class="flex flex-row py-2">
                            <div class="w-auto">
        ...
        <div id="popup-warning-frc"
            ...
            <div
                ...
                <button onclick="closeWarnFrc()"
                    class="mx-1 border-2 rounded-xl hover:bg-orange-800 hover:border-orange-300 border-orange-900 bg-orange-400 font-averialibre text-2xl px-2  w-full py-1 h-16 text-center hover:text-orange-300 text-orange-700">
                    <p class="font-averialibre text-2xl ">Batal</p>
                </button>
                <button onclick="hapusFrc()"
                    class="mx-1 border-2 rounded-xl hover:bg-orange-400 hover:border-orange-800 border-orange-900 bg-orange-800 font-averialibre text-2xl px-2  w-full py-1 h-16 text-center hover:text-orange-700 text-orange-300">
                    <p class="font-averialibre text-2xl ">Hapus</p>
                </button>
            </div>
        ...
        <div id="popup-edit"
            ...
            <div
                ...
                <p class="text-orange-800 font-averialibre text-xl md:text-4xl mx-auto mb-3 md:mb-7 mt-10 md:mt-6"
                ...
                <button type="submit" onclick="formComplete()"
        ...
        <div id="header" x-data="{ isOpen: false }"
            class="fixed rounded-b-2xl border-x-2 border-b-2 border-orange-300  bg-orange-700  justify-center z-40 w-[97%] md:hidden flex items-center flex-col">

            <button @click="isOpen = !isOpen" type="submit" class="w-full">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 my-2 text-orange-300 lg:hidden mx-auto"
            ...
            <div class="w-full">
                ...
                <div class="flex left-0 w-full px-3 pt-4 pb-6 bg-orange-300 rounded-b-xl" x-show="isOpen"
                    ...
                    <div class="flex flex-col space-y-4 w-full items-center">
                        ...
                        <a class="text-orange-700 font-averialibre cursor-pointer text-2xl" href="/bulk-order">BULK
                            ORDER</a>
                        <a class="text-orange-700 font-averialibre cursor-pointer text-2xl"
                            href="/">FRANCHISE</a>
                        <a class="text-orange-700 font-averialibre cursor-pointer text-2xl" href="/">ABOUT
                            US</a>
                        <a class="text-orange-700 font-averialibre cursor-pointer text-2xl" href="/">MY
                            DASHBOARD</a>
                    </div>
                </div>
        ...
        <div class="relative w-full">
            ...
            <div id="navbar" class="hidden md:flex justify-between w-screen h-16 pt-3 pr-5 items-center z-10 mt-2">
                ...
                <div
                    ...
                    <a href=""
                        class="text-orange-800 font-averialibre hover:font-averialibrebold text-2xl">About Us</a>
        ...
        <div class="w-full flex flex-col z-10 px-5 md:px-3 md:pl-7 py-7 bg-[#FF6400]">
            ...
            <p class="text-orange-800 font-averialibre text-lg md:text-xl w-full md:w-[70%] text-justify mb-6">
                mammapang is Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
